...
{   
    ...
    public class ApiService
    {
        ...
        public async Task<TokenResponse> GetToken(string urlBase,string username,
        string password)
        {
            try
            {
        ...
        public async Task<Response> GetList<T>(string urlBase, string prefix, string controller,string tokenType,string accesToken)
        {
            try
            {
                var client = new HttpClient();
        ...
        public async Task<Response> GetList<T>(string urlBase, string prefix, string controller,int id, string tokenType, string accesToken)
        {
            try
            {
                var client = new HttpClient();
        ...
        public async Task<Response> Post<T>(string urlBase, string prefix, string controller, T model, string tokenType, string accesToken)
        {
            try
            {
                var request = JsonConvert.SerializeObject(model);
        ...
        public async Task<Response> Delete(string urlBase, string prefix, string controller, int id, string tokenType, string accesToken)
        {
            try
            {
                var client = new HttpClient();
        ...
        public async Task<Response> Put<T>(string urlBase, string prefix, string controller, T model, int id, string tokenType, string accesToken)
        {
            try
            {
                var request = JsonConvert.SerializeObject(model);
